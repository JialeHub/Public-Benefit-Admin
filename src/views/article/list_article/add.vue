    ...
    <el-card
      ...
      <el-form :model="form" :rules="rules" ref="Form" label-width="5rem" hide-required-asterisk>
        ...
        <el-form-item label="文章图片" prop="cover">
          <add-cover ref="AddFramework" @getImage="getImage" style="padding-top: 10px;"
                       :imageUrl="$addBaseURL(form.cover)"></add-cover>
        </el-form-item>
...
<script>
  import addCover from "./component/ImageUploaderPlus";
