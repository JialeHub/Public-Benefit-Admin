<template>
  <div class="image-uploader-plus-user">
    <el-upload
...
<script>
  ...
  import {uploadFileApi, uploadPictureApi} from "@/api/file";
...
<style lang="scss">
  ...
  .image-uploader-plus-user {
    ...
    .image-uploader-icon {
      font-size: 28px;
      color: #8c939d;
      width: $image-uploader-plus-width-user;
      height: $image-uploader-plus-height-user;
      line-height: $image-uploader-plus-height-user;
      text-align: center;
    }
